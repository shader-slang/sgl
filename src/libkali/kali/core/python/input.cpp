...
KALI_PY_EXPORT(core_input)
{
    ...
    nb::kali_enum<MouseButton>(m, "MouseButton", D(MouseButton));
    nb::kali_enum<KeyModifierFlags>(m, "KeyModifierFlags", D(KeyModifierFlags));
    nb::kali_enum<KeyModifier>(m, "KeyModifier", D(KeyModifier));
    nb::kali_enum<KeyCode>(m, "KeyCode", D(KeyCode));

    nb::kali_enum<KeyboardEventType>(m, "KeyboardEventType", D(KeyboardEventType));
    ...
    nb::kali_enum<GamepadEventType>(m, "GamepadEventType", D(GamepadEventType));
    nb::kali_enum<GamepadButton>(m, "GamepadButton", D(GamepadButton));
