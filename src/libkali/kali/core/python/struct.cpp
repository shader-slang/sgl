...
KALI_PY_EXPORT(core_struct)
{
    ...
    nb::kali_enum<Struct::Type>(struct_, "Type", D(Struct, Type));
    nb::kali_enum<Struct::Flags>(struct_, "Flags", D(Struct, Flags)).def_enum_operators();
    nb::kali_enum<Struct::ByteOrder>(struct_, "ByteOrder", D(Struct, ByteOrder));
