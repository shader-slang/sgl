...
template<typename T, int N>
struct std::less<::kali::math::vector<T, N>> {
    constexpr bool operator()(const ::kali::math::vector<T, N>& lhs, const ::kali::math::vector<T, N>& rhs) const
    {
        for (int i = 0; i < N; ++i)
            if (lhs[i] != rhs[i])
                return lhs[i] < rhs[i];
...
template<typename T, int N>
struct std::equal_to<::kali::math::vector<T, N>> {
    constexpr bool operator()(const ::kali::math::vector<T, N>& lhs, const ::kali::math::vector<T, N>& rhs) const
    {
        for (int i = 0; i < N; ++i)
            if (lhs[i] != rhs[i])
...
template<typename T, int N>
struct std::not_equal_to<::kali::math::vector<T, N>> {
    constexpr bool operator()(const ::kali::math::vector<T, N>& lhs, const ::kali::math::vector<T, N>& rhs) const
    {
        for (int i = 0; i < N; ++i)
            if (lhs[i] == rhs[i])
...
template<typename T, int N>
struct std::hash<::kali::math::vector<T, N>> {
    constexpr int operator()(const ::kali::math::vector<T, N>& v) const
    {
        size_t result = 0;
        for (int i = 0; i < N; ++i)
...
template<typename T, int N>
struct fmt::formatter<kali::math::vector<T, N>> : formatter<T> {
    template<typename FormatContext>
    auto format(const kali::math::vector<T, N>& v, FormatContext& ctx) const
    {
        auto out = ctx.out();
        for (int i = 0; i < N; ++i) {
