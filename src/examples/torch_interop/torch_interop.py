...
device = kali.Device(type=kali.DeviceType.d3d12, enable_debug_layers=True, enable_cuda_interop=True)
kernel = device.load_module(Path(__file__).parent / "add.slang").create_compute_kernel(
    "main"
)
