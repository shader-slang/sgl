...
SGL_PY_EXPORT(device_reflection)
{
    ...
    nb::class_<TypeLayoutReflection>(m, "TypeLayoutReflection")
        ...
        .def("size", &TypeLayoutReflection::size, "parameter_type"_a = TypeReflection::ParameterCategory::uniform)
        .def("stride", &TypeLayoutReflection::size, "parameter_type"_a = TypeReflection::ParameterCategory::uniform)
        .def("alignment", &TypeLayoutReflection::size, "parameter_type"_a = TypeReflection::ParameterCategory::uniform)
