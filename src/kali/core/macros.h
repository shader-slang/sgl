...
#define KALI_DISABLE_MSVC_WARNING(w) KALI_DISABLE_WARNING(w)
#define KALI_DISABLE_CLANG_WARNING(w)
#define KALI_DISABLE_GCC_WARNING(w)
#elif KALI_CLANG
...
#define KALI_DISABLE_MSVC_WARNING(w)
#define KALI_DISABLE_CLANG_WARNING(w) KALI_DISABLE_WARNING(w)
#define KALI_DISABLE_GCC_WARNING(w)
#elif KALI_GCC
#define KALI_DO_PRAGMA(x) _Pragma(#x)
...
#define KALI_DISABLE_MSVC_WARNING(w)
#define KALI_DISABLE_CLANG_WARNING(w)
#define KALI_DISABLE_GCC_WARNING(w) KALI_DISABLE_WARNING(w)
#endif
