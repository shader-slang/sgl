...
KALI_API uint16_t float32_to_float16(float value);
KALI_API float float16_to_float32(uint16_t value);
...
template<>
class numeric_limits<kali::math::float16_t> {
public:
    static constexpr bool is_specialized = true;
    static constexpr kali::math::float16_t min() noexcept { return kali::math::float16_t::fromBits(0x0200); }
    static constexpr kali::math::float16_t max() noexcept { return kali::math::float16_t::fromBits(0x7bff); }
    static constexpr kali::math::float16_t lowest() noexcept { return kali::math::float16_t::fromBits(0xfbff); }
    ...
    static constexpr kali::math::float16_t epsilon() noexcept { return kali::math::float16_t::fromBits(0x1200); }
    static constexpr kali::math::float16_t round_error() noexcept { return kali::math::float16_t::fromBits(0x3c00); }
    ...
    static constexpr kali::math::float16_t infinity() noexcept { return kali::math::float16_t::fromBits(0x7c00); }
    static constexpr kali::math::float16_t quiet_NaN() noexcept { return kali::math::float16_t::fromBits(0x7fff); }
    static constexpr kali::math::float16_t signaling_NaN() noexcept { return kali::math::float16_t::fromBits(0x7dff); }
    static constexpr kali::math::float16_t denorm_min() noexcept { return kali::math::float16_t::fromBits(0); }
